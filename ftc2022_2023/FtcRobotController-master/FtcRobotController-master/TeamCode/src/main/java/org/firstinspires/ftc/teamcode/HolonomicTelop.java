...
public class HolonomicTelop extends OpMode
{
    ...
    public void init()
    {
       ...
       /* grabberWheels = hardwareMap.crservo.get("GRAB");
    ...
    public void loop()
    {
      ...
      //  linkageMotor.setPower( -0.4 * gamepad2LeftY);
        // Set servo to lock / unlock.

        if(gamepad2ButtonB)
        {
           // grabberWheels.setPower(0.8);
        ...
        if(gamepad2ButtonX)
        {
          //duckMotor.setPower(0.5);
           ...
           // baseServoRight.setPosition(0.2);
            System.out.println("duckmotor is going forwards!");
        }
        else if(gamepad2ButtonY)
        {
            System.out.println("duckmotor is going backwards!");
            //duckMotor.setPower(-0.5);
